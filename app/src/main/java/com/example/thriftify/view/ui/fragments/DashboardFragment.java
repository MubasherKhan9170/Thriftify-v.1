...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.dashboardFragment).build();
...
/*    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        *//* Handle item selection *//*
        ...
        if (itemId == R.id.dashboard_app_bar_logout) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        NavController navController = Navigation.findNavController(this.getActivity(), R.id.nav_host_container);
