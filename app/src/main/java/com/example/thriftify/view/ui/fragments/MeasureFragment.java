...
public class MeasureFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.measureFragment).build();
        Toolbar toolbar = view.findViewById(R.id.toolbar_measure);
